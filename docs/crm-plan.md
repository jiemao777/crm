...
> **Superseded.** This describes the pre-pivot HubSpot-style product. The repo is now a foreign-trade CRM — see [`plan/foreign-trade-crm.md`](plan/foreign-trade-crm.md). Kept for reference.
